...
def startDriver(int hubIndex, int capabilitiesIndex) {
  ...
  val hubMap = newHashMap (
    1 -> "http://0.0.0.0:4444/wd/hub",  // Functional
    2 -> "http://0.0.0.0:4445/wd/hub",  // Accessibility
...
def executeTestRun (int hubIndex, int capabilityIndex, String resetDataEnabled, String resetDataTag, String journeyStart, String videoPluginEnabled, String reportDirectory, String testRunIdentifier, int videoPause, String accessibilityPluginEnabled, String accessibilityCaptureImage, int accessibilityPause, List<String> journeyList, String ptcBddIdentifier, String ptcTitle, String ptcAction, String ptcNameElement, String ptcByElement, String ptcInputCheck, String ptcInclude, int ptcPause) { 
  ...
  executePointTestCases(driver, accessibilityPluginEnabled, accessibilityCaptureImage, accessibilityPause, testRunIdentifier, reportDirectory, ptcBddIdentifier, ptcTitle, ptcAction, ptcNameElement, ptcByElement, ptcInputCheck, ptcInclude, ptcPause)
