                            ...
                            journeyObjects.forEach [
                                ...
                                if (sequenceIdentifier.equals(jtcBddIdentifier)) {
                                    ...
                                    if (journeyDocumentReadyState == "complete") {
                                        if (mapSurface == "Y")
                                            getSurface(driver, journeyCaseStartUrl, jtcBddIdentifier, reportDirectory,
                                                uniqueRunIdentifier)
                                        else
                                            checkSurface(driver, journeyCaseStartUrl, jtcBddIdentifier, reportDirectory,
                                                uniqueRunIdentifier)
                                        print("  |-- " + jtcComments)
                                        ...
                                        switch jtcAction {
                                            ...
                                            case ( jtcAction == "click") :
                                                doUserAction(runAccessibility, driver.getCurrentUrl, accessibilityPause,
                                                    driver, uniqueRunIdentifier,
                                                    uniqueRunIdentifier + "_TC_" + jtcBddIdentifier, reportDirectory,
                                                    jtcInputCheck, jtcAction,
